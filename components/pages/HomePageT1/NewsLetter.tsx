...
const NewsLetter = () => {
  return (
    <div className=" sm:px-8 md:px-22 xl:px-10 relative overflow-hidden flex flex-col w-full h-[800px]">
      <div className="object-cover aspect-square">
        <Image src="/images/NewsLetter.png" alt="bg-vector" fill={true} />
      </div>
      <div className="absolute container flex flex-col sm:py-12 py-4 md:px-0 xl:px-44 x:container">
        <h3 className="text-white text-xs sm:text-sm font-semibold">Join Our</h3>
        <h1 className="text-white text-4xl sm:text-5xl font-bold">News Letter</h1>

        <div className="justify-end flex flex-row gap-8 xl:mr-0 sm:mr-16 sm:my-0 my-2">
          <a
            href=""
            className="xl:w-[300px] sm:w-[150px] w-[120px] h-[30px] sm:h-[44px] bg-white items-center flex justify-center rounded-md sm:rounded-xl"
          >
          ...
          >
            <p className="text-theme-secondary sm:text-base text-xs place-self-center">Go</p>
          </a>
        </div>
        ...
        <div className="flex text-white flex-col sm:flex-row gap-4 sm:gap-4 xl:gap-32 sm:mt-24 mt-8">
          <div className="flex flex-col gap-1 sm:gap-3">
            <h1 className="text-sm sm:text-2xl font-bold">Contact Us</h1>
            <div className="flex flex-row gap-3 justify-start">
              <FaLocationPin size={17} />
              <p className="text-xs sm:text-base font-light w-[180px] ">12345 ABCDE Ab.#1234 Place, FL 12345</p>
            </div>
            ...
            <div className="flex flex-row gap-3">
              <GrMail size={17} />
              <p className="text-xs sm:text-base font-light">info@mosqueonline</p>
            </div>
          </div>
          <div className="flex flex-col w-[179px] gap-2">
            ...
            <a href="" className="text-xs sm:text-base font-light">Home</a>
            <a href="" className="text-xs sm:text-base font-light">AboutUs</a>
            <a href="" className="text-xs sm:text-base font-light">Pillars of Islam</a>
            <a href="" className="text-xs sm:text-base font-light">Event & blog</a>
            <a href="" className="text-xs sm:text-base font-light">Gallery</a>
            <a href="" className="text-xs sm:text-base font-light">Contact</a>
            </div>
          </div>
          <div className="flex flex-col w-[179px] gap-2">
            <h1 className="text-sm sm:text-2xl font-bold">Quick Links</h1>
            <div className="flex flex-col font-light gap-2">
            <a href="" className="text-xs sm:text-base">Namaz Timings</a>
            <a href="" className="text-xs sm:text-base">FAQ</a>
            </div>
          </div>
        ...
        <div className="text-center items-center justify-center flex flex-col mt-2 sm:mt-8">
          ...
          <p className="xl:w-[804px] text-xs sm:text-sm xl:text-base text-white font-light">
